                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p>Order Notes</p>
                                <input type="text" placeholder="Notes about your order, e.g. special instructions for delivery.">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__subtotal">Subtotal <span>$00.00</span></div>
                                <div class="checkout__order__total">Total <span>$00.00</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="payment">
                                        Check Payment
